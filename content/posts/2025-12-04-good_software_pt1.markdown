...
{{< unsafe >}}
    <p style="">
        <img src="/assets/img/GoodSoftware_SplitDefinition.png" style="width:70%;display: block;margin-left: auto;margin-right: auto;"/>
        <span style="font-size:0.5em;text-align: center;display: block;">
            <strong>The split definition of good software</strong> ∙ 03 December 2025
        </span>
    </p>
{{< /unsafe >}}

## What “Good Software” Used To Mean
...
## Why the Old Definition Fails in 2025
...
[The Design Management Institute’s](https://www.dmi.org/page/DesignValue) long-running analysis shows that companies with strong structural and design quality outperform the S&P 500 by **211 percent** over a ten-year period.

Conversely, McKinsey estimates that [**40 percent of all IT budgets are spent on technical debt**](https://www.mckinsey.com/capabilities/tech-and-ai/our-insights/breaking-technical-debts-vicious-cycle-to-modernize-your-business) - not innovation.
...
According to the [**Google DORA 2024 report**](https://dora.dev/), AI-assisted development increased coding speed by **55 percent**, while delivery stability dropped by **7.2 percent**.
...
## The Split in Definitions: Enterprise “Good” vs. Individual “Good Enough”
A second force is reshaping the definition of quality: the rise of no-code and the shift toward individual creation. Platforms like **Lovable** demonstrate this trend clearly. According to [published case studies](https://digitalstrategy-ai.com/2025/06/19/lovable-no-code-software/), the platform grew from **$0 to $30M ARR in 120 days** and serves tens of thousands of creators.
...
### Enterprise-Grade “Good Software.”
...
### Individual “Good Enough Software.”
...
## A Blind Spot: Intent vs. Outcome
...
* **Exponential growth in low-quality code**, as summarized in the [SEI Carnegie Mellon blog](https://www.sei.cmu.edu/blog/building-quality-software-4-engineering-centric-techniques/) on quality engineering;
* **A growing market** where “good enough” solutions expand but rarely scale

Additionally, [**Mary Shaw’s work**](http://www.cs.cmu.edu/~Compose/ftp/shaw-fin-etaps.pdf) at Carnegie Mellon explains why software engineering must apply systematic evaluation, not intuition, when judging quality:

These academic and industry findings point to the same conclusion:
...
3. **The competitive environment has changed** - Companies that invest in structural quality move faster *and* safer.
4. **The cost structure has changed** - Technical debt behaves like compound interest. Delay multiplies cost.

Ignoring these shifts is not a neutral act. It is a strategic risk.


## The First Move: Re-Establish Intent
